                ...
                "changes": [
                    {
                        ...
                        "items": [
                            ...
                            "Dropdown для выбора отдельных шаблонов (Общий отчёт вынесен отдельно)",
                            "Спиннер загрузки файлов с отображением прогресса обработки",
                            "Кнопки навигации (Назад/Далее) в заголовках панелей",
                            "Компактный статус загрузки (галочка + количество файлов)"
                        ]
                    },
                    {
                        "category": "Изменено",
                        "items": [
                            "Кнопка «Начать заново» перенесена в header панели обработки",
                            "Структура навигации между шагами загрузки файлов"
                        ]
                    },
                    {
                        "category": "Исправлено",
                        "items": [
                            "«Октябрь» заменён на «Месяц» в заголовках таблицы T9"
                        ]
                    },
                    {
                        "category": "Удалено",
                        "items": [
                            "Устаревший шаблон merge-files.js"
                        ]
                    }
                ]
            },
